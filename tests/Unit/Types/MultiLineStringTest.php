...
class MultiLineStringTest extends BaseTestCase
{
    ...
    public function testInvalidGeoJsonException()
    {
        $this->assertException(
            \EdipoElwes\LaravelMysqlSpatial\Exceptions\InvalidGeoJsonException::class,
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'EdipoElwes\LaravelMysqlSpatial\Types\MultiLineString must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfLineString()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'EdipoElwes\LaravelMysqlSpatial\Types\MultiLineString must be a collection of EdipoElwes\LaravelMysqlSpatial\Types\LineString'
        );
        $multilinestring = new MultiLineString([
